...
The exam emphasis you mentioned fits the slide progression very closely: MDP formalism, Bellman expectation/optimality, DP, then model-free learning, then DQN.
...
That is the **Bellman expectation equation** for $v_\pi$.
